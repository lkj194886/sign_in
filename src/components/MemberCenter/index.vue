<template>
  <div class="MenberFlex">
    ...
    <div class="MemberName">
      ...
      <span class="numberSpan">{{ user.userName }}</span>
    </div>
    <hr
    ...
    <div class="MemberList">
      <div class="Memberlistson">
        ...
        <span class="numberSpan">{{ user.userInvitationCode }}</span>
      </div>
      <div class="Memberlistson">
        <span class="iconfont1 icon-shoujihao1"></span>
        <span class="left_title1">{{ MemberListName[1].phone }}</span>
        <span class="numberSpan1">{{ user.userName }}</span>
      </div>
      <div class="Memberlistson">
      ...
      <div class="Memberlistson" @click="GoWeixin">
        ...
        <span class="left_title1">{{
          MemberListName[5].weixinWithdrawal
        }}</span>
        <span class="iconfont1 icon-dayu1"></span>
      </div>
      <div class="Memberlistson" @click="GoZhifubao">
        ...
        <span class="left_title1">{{
          MemberListName[6].zhifubaoWithdrawal
        }}</span>
        <span class="iconfont1 icon-dayu1"></span>
      </div>
    </div>
  ...
  data() {
    return {
      ...
      MemberListImg: [
        ...
        {
          weixinWithdrawal: require("../../static/img/weixinWithdrawal.png"),
          id: 7,
        },
        {
          zhifubaoWithdrawal: require("../../static/img/zhifubaoWithdrawal.png"),
          id: 8,
        },
      ],
  ...
  methods: {
    ...
    showDialog() {
      Dialog.alert({
        ...
        message:
          "●普通会员每日可以领3次福利，提现手续费95%，投放广告计价每小时低至24七币\n" +
